# /deep-research — Exhaustive Multi-Agent Research

Exhaustive multi-agent research on any topic. Parallel search, URL
fetching, gap analysis, adversarial validation, citation check.

Usage: `/deep-research <research question or topic>`
...
> /deep-research protocol (parallel agents, validation, saved
...
- If the user's original message explicitly said "deep research",
  "/deep-research", or equivalently asked for the full protocol, skip
  the gate and proceed directly to Phase 0.
