...
echo "2. Present the task menu from above exactly as shown (scoreboard, numbered tasks"
echo "   grouped by parent, S/R options, prompt line)."
...
echo ""
echo "Adding tasks: when the user asks to add a task, confirm which parent heading"
echo "it belongs under, suggest blocking/blocked-by relationships or other properties"
echo "if applicable, then add it and confirm to the user."
echo ""
